...
import domain.TargetDatabaseConnector;
import domain.ToolDatabaseConnector;
...
//		while (!validTable) {
//			System.out.println(
//					"Kies de table waar je de constraint op wilt uitvoeren: (Alleen testTable werkt voor testen).");
...
//		while (!validColumn) {
//			System.out.println(
//					"Kies de column waar je de constraint op wilt uitvoeren: (Alleen testColumn werkt voor testen)");
